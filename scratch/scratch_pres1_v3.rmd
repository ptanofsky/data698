...
\begin{figure}
  \centering
  \subfloat[5 a.m.]{\includegraphics[width=3cm,trim={5cm 1cm 5cm 1cm}]{cb_stations_surplus_5A.jpg}}\hfil
  \subfloat[8 a.m.]{\includegraphics[width=3cm,trim={1cm 1cm 1cm 1cm}]{cb_stations_surplus_8A.jpg}}\hfil 
