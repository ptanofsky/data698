...
```{r trip.by.hour.time.series, echo=F, message=F, warning=F, include=T, fig.width=7, fig.asp=1.0}
...
```{r trip.by.hour.seasonal, echo=F, message=F, warning=F, include=T, fig.width=6, fig.asp=1.0}
citibike_by_hour_ts %>%
