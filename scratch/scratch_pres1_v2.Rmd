...
```{r display.citibike.photo, echo=F, message=F, warning=F, include=T, fig.height=5}
img <- readJPEG("citibike_rack.jpg")
...
System-wide view of surplus or shortage for every docking station
- Blue: surplus; Red: shortage; Green: even

```{r display.surplus.by.station, echo=F, message=F, warning=F, include=T, fig.height=5}
img <- readJPEG("stations_surplus_sum.jpg")
plot(1:10,ty="n", axes = 0, xlab='', ylab='')
rasterImage(img,-1,-1,12,12)
```
...
```{r display.surplus.by.station.multiples, echo=F, message=F, warning=F, include=T, fig.height=5}
par(mfrow=c(2,3))
img_5A <- readJPEG("cb_stations_surplus_5A.jpg")
img_8A <- readJPEG("cb_stations_surplus_8A.jpg")
img_11A <- readJPEG("cb_stations_surplus_11A.jpg")
img_2P <- readJPEG("cb_stations_surplus_2P.jpg")
img_5P <- readJPEG("cb_stations_surplus_5P.jpg")
img_8P <- readJPEG("cb_stations_surplus_8P.jpg")
plot(1:10,ty="n", axes = 0, xlab='', ylab='', main='5 a.m.')
rasterImage(img_5A,-1,-1,12,12)
plot(1:10,ty="n", axes = 0, xlab='', ylab='', main='8 a.m.')
rasterImage(img_8A,-1,-1,12,12)
plot(1:10,ty="n", axes = 0, xlab='', ylab='', main='11 a.m.')
rasterImage(img_11A,-1,-1,12,12)
plot(1:10,ty="n", axes = 0, xlab='', ylab='', main='2 p.m.')
rasterImage(img_2P,-1,-1,12,12)
plot(1:10,ty="n", axes = 0, xlab='', ylab='', main='5 p.m.')
rasterImage(img_5P,-1,-1,12,12)
plot(1:10,ty="n", axes = 0, xlab='', ylab='', main='8 p.m.')
rasterImage(img_8P,-1,-1,12,12)
```
...
Frequency of zero bike availability by docking station
- Two weeks
- 15-minute intervals

```{r display.bk.station.zero.avail, echo=F, message=F, warning=F, include=T, fig.height=5}
img <- readJPEG("bk_stations_zero_avail.jpg")
plot(1:10,ty="n", axes = 0, xlab='', ylab='', main='Brooklyn Docking Stations by Cluster')
rasterImage(img,-1,-1,12,12)
```
...
```{r display.bk.station.by.cluster, echo=F, message=F, warning=F, include=T, fig.height=5}
img <- readJPEG("bk_stations_by_cluster.jpg")
plot(1:10,ty="n", axes = 0, xlab='', ylab='', main='Brooklyn Docking Stations by Cluster')
rasterImage(img,-1,-1,12,12)
```
...
```{r current.achievements, echo=F, message=F, warning=F, include=T}
