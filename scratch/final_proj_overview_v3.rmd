...
The prediction model ultimately based the independent variable time on the hour of the day, hence the transition from 15-minute intervals to one-hour intervals in the research.
...
**Zero-Inflated Model:** A Zero-Inflated Model builds a model for a distribution that allows for frequent zero-value observations. The Zero-Inflated models used in this research use a base of Poisson (ZIP) and Negative Binomial (ZINB).
