...
At stated previously, our research attempts to answer the following questions:
...
\begin{figure}
  ...
  \subfloat[5 a.m.]{\includegraphics[width=0.49\textwidth, height=\textheight, keepaspectratio]{cb_stations_surplus_5A.jpg}}\hfil
  \subfloat[8 a.m.]{\includegraphics[width=0.49\textwidth, height=\textheight, keepaspectratio]{cb_stations_surplus_8A.jpg}}
  
  \subfloat[11 a.m.]{\includegraphics[width=0.49\textwidth, height=\textheight, keepaspectratio]{cb_stations_surplus_11A.jpg}}\hfil  
  \subfloat[2 p.m.]{\includegraphics[width=0.49\textwidth, height=\textheight, keepaspectratio]{cb_stations_surplus_2P.jpg}}
  
  \subfloat[5 p.m.]{\includegraphics[width=0.49\textwidth, height=\textheight, keepaspectratio]{cb_stations_surplus_5P.jpg}}\hfil
  \subfloat[8 p.m.]{\includegraphics[width=0.49\textwidth, height=\textheight, keepaspectratio]{cb_stations_surplus_8P.jpg}}
\end{figure}
...
The `dispersiontest` function from the `AER` library indicates a dispersion of `r disp_val`.
...
The plots of the residuals vs. the fitted values for Poisson, Quasi-Poisson, and Negative Binomial each indicate heteroscedasticity. The evidence of heteroscedasticity shows increasing variance with as the fitted values increase. The Poisson and Quasi-Poisson appear identical while the Negative Binomial plot is quite similar.

**Zero-Inflated Model:** A Zero-Inflated Model builds a model for a distribution that allows for frequent zero-values observations. The Zero-Inflated models used in this research use a base of Poisson (ZIP) and Negative Binomial (ZINB).
